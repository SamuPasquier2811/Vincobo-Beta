                                ...
                                <div key={reserva.id} className="card" style={{ borderLeft: `4px solid ${reserva.estado_pago === 'pagado' ? 'var(--success)' : reserva.estado_pago === 'pendiente' ? '#F59E0B' : 'var(--error)'}` }}>
                                    {editandoReserva === reserva.id ? (
                                        <div>
                                            ...
                                            <div className="form-group"><label className="form-label">Tipo de servicio</label><select className="form-input" value={formReserva.tipo_servicio || reserva.tipo_servicio} onChange={(e) => setFormReserva({ ...formReserva, tipo_servicio: e.target.value })}><option value="consulta">CONSULTA (15 min)</option><option value="carrera">CARRERA (45 min)</option></select></div>
